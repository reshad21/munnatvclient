  ...
  return (
    <div className="flex flex-col items-center justify-center mt-4 mb-8">
      ...
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="text-lg font-medium text-gray-700 -ml-5" style={{ fontFamily: 'Noto Sans Bengali, sans-serif' }}>Gallery</span>
      </div>
      {/* Main heading */}
      <h2 className="text-2xl md:text-3xl font-bold text-[#0f3d3e] text-center leading-tight">
        Our Memorable Moments Captured in the Gallery
      </h2>
    </div>
  );
};
